% The following MATLAB function int_gauss_quad.m computes the
% definite integral 10.1 using the Gaussian quadrature formula.
% INPUTS are a function f; the values of a and b; the value of n. 
function int_gauss_quad(f,a,b,n)
